package com.androidtutz.asystechs.ebookshop.WorkManager;
import android.content.Context;
import androidx.annotation.NonNull;
import androidx.work.Worker;
import androidx.work.WorkerParameters;

import com.androidtutz.asystechs.ebookshop.DemoApplication;
import com.androidtutz.asystechs.ebookshop.model.Book;
import com.androidtutz.asystechs.ebookshop.model.BookDAO;
import com.androidtutz.asystechs.ebookshop.model.BooksDatabase;
import com.androidtutz.asystechs.ebookshop.model.Category;
import com.androidtutz.asystechs.ebookshop.model.CategoryDAO;

public class InsertBulkData extends Worker {

    public InsertBulkData(@NonNull Context context, @NonNull WorkerParameters workerParams) {
    ...
    public Result doWork() {
        BooksDatabase booksDatabase=BooksDatabase.getInstance(DemoApplication.getApp());
        CategoryDAO categoryDAO=booksDatabase.categoryDAO();
        BookDAO bookDAO=booksDatabase.bookDAO();
        getInsertOnLoad(categoryDAO,  bookDAO);
        return Result.success();
    }



    public void getInsertOnLoad(CategoryDAO categoryDAO , BookDAO bookDAO) {
